...
export function SettingsMenu({
  ...
  const SHOW_PLAN_MODE_TOGGLE = false;
          ...
          <div className="px-4 py-2 text-xs text-slate-500 dark:text-slate-400">
            {SHOW_PLAN_MODE_TOGGLE && (
              <>
                ...
                <div>
                  Claude will outline implementation steps before executing any
                  code changes.
                </div>
              </>
            )}
            <div
              className={`font-medium mb-1 ${SHOW_PLAN_MODE_TOGGLE ? "mt-2" : ""}`}
            >
              Auth Mode:
            </div>
            <div>
